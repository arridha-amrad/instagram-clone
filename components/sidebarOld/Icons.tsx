...
export const MessengerOutlinedIcon = () => (
  <svg
    aria-label="Messenger"
    fill="currentColor"
    height="24"
...
export const NotificationsOutlinedIcon = () => (
  <svg
    aria-label="Notifications"
    fill="currentColor"
    height="24"
...
export const ExploreOutlinedIcon = () => (
  <svg
    aria-label="Explore"
    fill="currentColor"
    height="24"
...
export const ReelsOutlinedIcon = () => (
  <svg
    aria-label="Reels"
    fill="currentColor"
    height="24"
...
export const DefaultAvatar = ({ url }: { url: string }) => (
  <div className="ml-1 aspect-square w-8 overflow-hidden rounded-full">
    <Image
      alt="default-avatar"
      width={50}
      height={50}
...
export const OptionsFilledIcon = () => (
  <svg
    aria-label="Settings"
    fill="currentColor"
    height="24"
...
export const OptionsOutlinedIcon = () => (
  <svg
    aria-label="Settings"
    fill="currentColor"
    height="24"
